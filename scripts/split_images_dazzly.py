...
def main():
    args = {
        "inputs_dir": "../../Data/dazzly/for_segmentation/one_color_per_symbol/4096/bw",  # Path to input image directory.
        "output_dir": "../../Data/dazzly/for_segmentation/one_color_per_symbol/4096/bw_crop_srgan",  # Path to generator image directory.
        "crop_size": 1024, # 128,  # Crop image size from raw image.
        "step": 1024, # 64,  # Step size of sliding window.
        ...
        "num_images": 500 # None to split all images in folder
    }
...
def split_images(args: dict):
    ...
    image_file_paths = image_file_paths[:num_images]
